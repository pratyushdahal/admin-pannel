            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                       ...
                       <td> <a href="addnotices.php?id=<?=$id?>"><span class="status completed">Edit</a></span> <a type="button" href="notice.php?id=<?php echo $id; ?> " onclick="alert('Do you want to delete ')"><span style="background:red; color:white; margin-left:4px;" class="status completed">Delete</span> </a></td>
