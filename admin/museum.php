            ...
            <table>
                ...
                <tbody>
                    ...
                    ?> <tr>
                            ...
                            <td> <a href="editdetails.php?id=<?php echo $id; ?>"><span class="status completed">Edit</a></span> <a type="button" href="museum.php?mid=<?php echo $id; ?> " onclick="alert('Do you want to delete ')"><span style="background:red; color:white; margin-left:4px;" class="status completed">Delete</span> </a></td>
